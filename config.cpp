...
// include to access global humanization flag
...
bool Config::loadConfig(const std::string& filename)
{
    if (!std::filesystem::exists(filename))
    {
        ...
        // Humanization / Bezier (global flag)
        g_humanization_enabled = false;
    ...
    // Humanization / Bezier (global flag)
    g_humanization_enabled = get_bool("humanization_enabled", false);
...
bool Config::saveConfig(const std::string& filename)
{
    ...
    file << "# Mouse move\n"
        ...
        << "humanization_enabled = " << (g_humanization_enabled ? "true" : "false") << "\n"
