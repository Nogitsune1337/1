...
void draw_mouse()
{
    ...
    // Humanization checkbox placed in first section as requested
    // Humanization flag moved to global var g_humanization_enabled
    if (ImGui::Checkbox("Enable Humanization (Bezier)", &g_humanization_enabled))
    {
        config.saveConfig();
